CREATE TABLE bill_line_calc
(
  bill_line_calc_id   VARCHAR2(64)  NOT NULL ENABLE,
  bill_ln_id          VARCHAR2(64)  NOT NULL ENABLE,
  bill_id             VARCHAR2(64)  NOT NULL ENABLE,
  calc_ln_class       VARCHAR2(30)  NOT NULL ENABLE,
  calc_ln_type        VARCHAR2(30)  NOT NULL ENABLE,
  calc_ln_type_descr  VARCHAR2(60)                 ,
  amount              NUMBER        NOT NULL ENABLE,
  include_on_bill     CHAR(1)       NOT NULL ENABLE,
  rate_type           VARCHAR(16)                  ,
  rate_val            NUMBER                       ,
  tax_stat            VARCHAR2(3)                  ,
  tax_rate            NUMBER                       ,
  tax_stat_descr      VARCHAR2(60)  NOT NULL ENABLE,
