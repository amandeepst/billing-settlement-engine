...
DROP TABLE ACCT_HIER;
  CREATE TABLE ACCT_HIER
   (PARENT_ACCT_PARTY_ID VARCHAR2(16 BYTE)  NOT NULL ENABLE,
    PARENT_ACCT_ID VARCHAR2(60 BYTE)            NOT NULL ENABLE,
    CHILD_ACCT_PARTY_ID VARCHAR2(16 BYTE)   NOT NULL ENABLE,
    CHILD_ACCT_ID VARCHAR2(60 BYTE)             NOT NULL ENABLE,
    ...
    PARTITION_ID NUMBER(5,0)          	    GENERATED ALWAYS AS (ORA_HASH(PARENT_ACCT_ID || CHILD_ACCT_ID, 15)) VIRTUAL,
  CONSTRAINT "PK_ACCT_HIER" PRIMARY KEY ("CHILD_ACCT_ID")
)
