DROP TABLE SUB_ACCT;
  CREATE TABLE SUB_ACCT
   (SUB_ACCT_ID VARCHAR2(60 BYTE)          NOT NULL ENABLE,
    ACCT_ID VARCHAR2(60 BYTE)              NOT NULL ENABLE,
    SUB_ACCT_TYPE CHAR(4 BYTE)             NOT NULL ENABLE,
    ...
    PARTITION_ID NUMBER(5,0)          	    GENERATED ALWAYS AS (ORA_HASH(SUB_ACCT_ID, 15)) VIRTUAL,
  CONSTRAINT "PK_SUB_ACCT" PRIMARY KEY ("SUB_ACCT_ID")
)
